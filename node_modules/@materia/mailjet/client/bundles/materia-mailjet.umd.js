(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/common/http'), require('@angular/forms'), require('@angular/flex-layout'), require('ngx-echarts'), require('@materia/addons'), require('@angular/material'), require('@angular/platform-browser'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@materia/mailjet', ['exports', '@angular/common', '@angular/common/http', '@angular/forms', '@angular/flex-layout', 'ngx-echarts', '@materia/addons', '@angular/material', '@angular/platform-browser', '@angular/core'], factory) :
    (factory((global.materia = global.materia || {}, global.materia.mailjet = {}),global.ng.common,global.ng.common.http,global.ng.forms,global.ng['flex-layout'],global.ngxEcharts,global.addons,global.ng.material,global.ng.platformBrowser,global.ng.core));
}(this, (function (exports,common,http,forms,flexLayout,ngxEcharts,addons,material,platformBrowser,core) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TemplateEditorComponent = /** @class */ (function () {
         ...
         */
            function () {
                this.templateForm = this.fb.group({
                    ...
                    author: [this.user ? this.user.Username : '', forms.Validators.required],
                    templateType: ['transactional', forms.Validators.required]
                });
            };
        /**
         * @return {?}
        ...
        /** @nocollapse */
        TemplateEditorComponent.ctorParameters = function () {
            return [
                { type: forms.FormBuilder }
            ];
        };
        TemplateEditorComponent.propDecorators = {
            edition: [{ type: core.Input }],
            settings: [{ type: core.Input }],
            user: [{ type: core.Input }],
            cancelled: [{ type: core.Output }],
            confirmed: [{ type: core.Output }],
            template: [{ type: core.ViewChild, args: ['templateDialog',] }]
        };
    ...
    var SendModalComponent = /** @class */ (function () {
         ...
         */
            function () {
                this.templateVariablesControl.push(this.fb.group({
                    name: [null, forms.Validators.required],
                    value: [null, forms.Validators.required]
                }));
            };
        /**
         * @param {?} index
            ...
            function (type) {
                ...
                if (this.type === 'simple') {
                    this.sendForm = this.fb.group({
                        to: [this.to ? this.to : '', forms.Validators.required],
                        subject: [this.subject ? this.subject : '', forms.Validators.required],
                        body: [''],
                    ...
                    this.sendForm = this.fb.group({
                        to: [this.to ? this.to : '', forms.Validators.required],
                        subject: [this.subject ? this.subject : '', forms.Validators.required],
                        template: [this.templateId, forms.Validators.required],
                        variables: this.fb.array([])
                    });
                }
            };
        ...
        /** @nocollapse */
        SendModalComponent.ctorParameters = function () {
            return [
                { type: forms.FormBuilder }
            ];
        };
        SendModalComponent.propDecorators = {
            to: [{ type: core.Input }],
            templateId: [{ type: core.Input }],
            templates: [{ type: core.Input }],
            subject: [{ type: core.Input }],
            type: [{ type: core.Input }],
            confirmed: [{ type: core.Output }],
            cancelled: [{ type: core.Output }],
            template: [{ type: core.ViewChild, args: ['sendDialog',] }]
        };
    ...
    var MailjetViewComponent = /** @class */ (function () {
        function MailjetViewComponent(http$$1, dialog, datePipe) {
            this.http = http$$1;
            this.dialog = dialog;
            this.datePipe = datePipe;
            this.openSetup = new core.EventEmitter();
            this.openInBrowser = new core.EventEmitter();
            this.snackbarSuccess = new core.EventEmitter();
            this.snackbarError = new core.EventEmitter();
            this.emails = [];
            this.stats = {};
            this.statusColors = {
                sent: '#2196F3',
        ...
        /** @nocollapse */
        MailjetViewComponent.ctorParameters = function () {
            return [
        ...
        MailjetViewComponent.propDecorators = {
            ...
            openInBrowser: [{ type: core.Output }],
            snackbarSuccess: [{ type: core.Output }],
            snackbarError: [{ type: core.Output }],
            templateEditor: [{ type: core.ViewChild, args: [TemplateEditorComponent,] }],
            sendModalComponent: [{ type: core.ViewChild, args: [SendModalComponent,] }]
        };
        MailjetViewComponent = __decorate([
            addons.AddonView('@materia/mailjet'),
    ...
    var MailjetHeaderComponent = /** @class */ (function () {
        function MailjetHeaderComponent() {
            this.settingsOpened = new core.EventEmitter();
            this.sendDialogOpened = new core.EventEmitter();
            this.timelineChanged = new core.EventEmitter();
        }
        ...
        MailjetHeaderComponent.propDecorators = {
            ...
            settingsOpened: [{ type: core.Output }],
            sendDialogOpened: [{ type: core.Output }],
            timelineChanged: [{ type: core.Output }]
        };
    ...
    var SafeTemplatePipe = /** @class */ (function () {
        ...
        SafeTemplatePipe.decorators = [
            { type: core.Pipe, args: [{ name: 'safeTemplate' },] }
        ];
        /** @nocollapse */
        SafeTemplatePipe.ctorParameters = function () {
            return [
    ...
    exports.MailjetViewComponent = MailjetViewComponent;
    exports.UI_MODULES = UI_MODULES;
    exports.MailjetModule = MailjetModule;
    exports.ɵg = MailjetHeaderComponent;
    exports.ɵf = MailjetStatisticComponent;
    exports.ɵc = MailjetViewComponent;
    exports.ɵe = StatsCounterComponent;
    exports.ɵi = SendModalComponent;
    exports.ɵh = TemplateEditorComponent;
    exports.ɵb = SendModalComponent;
    exports.ɵa = TemplateEditorComponent;
    exports.ɵd = SafeTemplatePipe;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=materia-mailjet.umd.js.map