...
const mailjet_1 = require("../../lib/mailjet");
class MailjetTemplate {
    constructor(app) {
        this.app = app;
        this.mailjetLib = new mailjet_1.MailjetSender(this.app);
    }
    list(params) {
    ...
    updateContent(params) {
        this.mailjetLib.reload();
        if (this.mailjetLib.mailjet) {
            const updateContent = this.mailjetLib.mailjet.post(`template/${params.ID}/detailcontent`);
            delete params.ID;
    ...
    getContent(params) {
        this.mailjetLib.reload();
        if (this.mailjetLib.mailjet) {
            const getContent = this.mailjetLib.mailjet.get(`template/${params.ID}/detailcontent`);
...
//# sourceMappingURL=mailjet-template.js.map