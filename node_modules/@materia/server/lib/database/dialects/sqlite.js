    ...
    showTables() {
        ...
        return this.sequelize.getQueryInterface().showAllTables().then((tables) => {
            tables.forEach(table => {
                ...
                const aiQuery = this.sequelize.query(`SELECT 1 as name FROM sqlite_master WHERE type = 'table' AND name = ? AND sql LIKE '%AUTOINCREMENT%'`, { replacements: [table], raw: true, plain: true
                });
