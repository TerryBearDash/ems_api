...
class FindOneQuery extends query_1.Query {
    ...
    run(params, options) {
        this.entity.app.logger.log(`${chalk_1.default.bold('(Query)')} FindOne - Run ${chalk_1.default.bold(this.entity.name)}.${chalk_1.default.bold(this.id)}`);
        ...
        return this.handleBeforeActions(params, true)
            .then(() => this.entity.model.findOne(sequelizeOpts)).then(res => {
