...
describe('[Fields]', () => {
    ...
    describe('App', () => {
        it('should prepare an entity "test" with data', () => {
            ...
            }).then(() => app.entities.get('test').getQuery('create').run()).then(() => app.entities.get('test').getQuery('get').run({ id_test: 1 }, { raw: true })).should.become({ id_test: 1 });
        });
...
//# sourceMappingURL=fields-changes.test.js.map