...
describe('[Renaming tests]', () => {
    ...
    describe('App', () => {
        it('should prepare entities "test" and "test2"', () => {
            ...
            })).then(() => app.entities.get('test').getQuery('create').run()).then(() => app.entities.get('test2').getQuery('create').run()).then(() => app.entities.get('test').getQuery('get').run({ id_test: 1 }, { raw: true })).should.become({ id_test: 1 });
        });
...
//# sourceMappingURL=renaming.test.js.map