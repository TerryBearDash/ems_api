...
class TemplateApp {
    ...
    createApp(app_path, mode) {
        const debug_mode = !!process.env.DEBUG;
        mode = mode || 'dev';
        const app = new app_1.App(app_path, {
        ...
        app.config.set({
            'host': 'localhost',
            'port': 8798
        }, mode, config_1.ConfigType.SERVER);
        ...
        if (process.env.DIALECT == 'postgres') {
            ...
            app.config.set(cnf, mode, config_1.ConfigType.DATABASE);
        }
        else {
            const cnf = {
                type: 'sqlite',
    ...
    runApp(mode) {
        return __awaiter(this, void 0, void 0, function* () {
            const app = yield this.createInstance(mode || 'dev');
    ...
    resetApp(app, while_off) {
        return __awaiter(this, void 0, void 0, function* () {
            let new_app;
            yield app.stop();
            new_app = yield this.createApp(app.path);
    ...
    promisifyRequest(method, url, args, type) {
...
exports.TemplateApp = TemplateApp;
